...
registered_pcd_path = f"/mnt/data/workspace/deformable/generator/captures/exp{EXP_NO}/registered_pcd/{PCD}.ply"
cropped_pcd_path = f"/mnt/data/workspace/deformable/generator/captures/exp{EXP_NO}/registered_pcd/{PCD}_cropped.ply"
...
inlier_cloud = rotate_pcd(inlier_cloud, [(Y_ROTATION/180) * math.pi, 0, 0])
to_be_drawn.append(inlier_cloud)
to_be_drawn.append(removed_cloud)
